...
dpcpp -fintelfpga src/hdcinference.cpp -Xshardware -Xsboard=/opt/intel/oneapi/intel_s10sx_pac:pac_s10 -o ./bin/inference.fpga -DFPGA=1 -O2 -fp-model=fast=2 -Xsffp-reassociate
